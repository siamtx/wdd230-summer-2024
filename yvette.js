...
if (matchResults && (numVisits !== 1)) { visitsDisplay.textContent = "Back so soon! Awesome!" } 
else if (numVisits = 1) { visitsDisplay.textContent = "Welcome! Let us know if you have any questions."; } 
else { visitsDisplay.textContent = "Number of Visits: "+ numVisits; } 

// Store the new date into localStorage, 
key=pDate localStorage.setItem("pDate", tDate); 

// Store the new visit total into localStorage, 
key=numVisits-ls numVisits++; 
